        ...
        <div className="bg-linear-to-br from-white/10 to-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6">
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-3 p-3 bg-white/5 rounded-xl">
              ...
              <div>
                <p className="text-sm text-white">Manage your events</p>
                <p className="text-xs text-gray-500 mt-1">Click on any event to view details, edit, or manage attendance</p>
              </div>
            </div>
            <div className="flex items-start gap-3 p-3 bg-white/5 rounded-xl">
              <span className="text-xl"><FaUsers /></span>
              <div>
                <p className="text-sm text-white">Track attendance in real-time</p>
                <p className="text-xs text-gray-500 mt-1">Use QR scanning or manual attendance to mark students</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-linear-to-br from-white/10 to-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-start gap-3 p-3 bg-white/5 rounded-xl">
              ...
              <div>
                <p className="text-sm text-white">Close events when done</p>
                <p className="text-xs text-gray-500 mt-1">Mark events as closed to finalize attendance and CS hours</p>
              </div>
            </div>
          </div>
        </div>
